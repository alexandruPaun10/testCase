            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Dashboard Overview</h6>
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="insert.php" class="btn btn-sm btn-neutral">Add Customer</a>
                    </div>
                </div>
                <!-- Card stats -->
                <div class="row">
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> 5.43%</span>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> 38.48%</span>
                                    <span class="text-nowrap">Since last month</span>
                                </p>
                            </div>
                        </div>
